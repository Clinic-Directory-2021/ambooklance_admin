...
import { getAddress, getAge, getBirthdate, getEmail, getFullName, getPhoneNumber, getUID, getUri, getPassword } from './EditResidentModel'
            ...
            await updateDoc(washingtonRef, {
              ...
              phone_number: phone_number,
                ...
                updateEmail(userID, email).then(() => {
                    alert('Successfully Modified Resident.')
